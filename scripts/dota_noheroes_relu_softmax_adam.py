...
players = players[['gold_per_min', 'hero_damage', 'hero_healing', 'level', 'kills', 'deaths', 'assists', 'item_0', 'item_1','item_2','item_3','item_4','item_5', 'win']].dropna(axis=0)
print(players.shape)

# Separate out the features and the labels. Our features are the items. Our label is if they won or not.
features = players[['gold_per_min', 'hero_damage', 'hero_healing', 'level', 'kills', 'deaths', 'assists', 'item_0', 'item_1','item_2','item_3','item_4','item_5', 'win']]
labels = players['win']
print(features.head())
print(labels.head())
...
# Setting up a neural network with 2 hidden layers
