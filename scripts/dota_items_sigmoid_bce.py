...
# Splitting the data set into training (80%) and test (20%); Encode to 0 or 1 for binary crossentropy strategy
...
y_train = tf.one_hot(y_train, depth=len(train_labels))
y_test = tf.one_hot(y_test, depth=len(test_labels))
print(x_train.shape)
print(x_test.shape)
